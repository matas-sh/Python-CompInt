...
public class AntennaArray {
    ...
    public static void main(String[] args) {
        AntennaArray antennaArray = new AntennaArray(3, 30);
        double[] design = new double[]{0.65, 0.95, 1.5};
        double designValue = antennaArray.evaluate(design);
        System.out.println("design value " + designValue);
    }
    /**
    ...
    public double evaluate(double[] design) {
        ...
        class PowerPeak {
            ...
            public void stringRep() {
                System.out.println("{ elevation: " + elevation + " power: " + power + " }");
            }
        }
